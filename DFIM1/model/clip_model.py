...
logger = logging.getLogger("DFIM.model")
...
def build_CLIP_from_openai_pretrained(check_model: str,name: str, image_size: Union[int, Tuple[int, int]], stride_size: int, jit: bool = False, download_root: str = None):
    """Load a CLIP model
    ...
    if check_model == 'O':
        model_path = "./checkpoints/open_clip_pytorch_model.bin"
    if check_model == 'R':
        model_path = "./checkpoints/RemoteCLIP-ViT-B-32.pt"
    if check_model == 'C_16':
        model_path = "./checkpoints/ViT-B-16.pt"
    if check_model == 'G':
        model_path = "./checkpoints/RS5M_ViT-B-32_RET-2.pt"
    if check_model == 'Gmin':
        model_path = "./checkpoints/RS5M_ViT-B-32.pt"
